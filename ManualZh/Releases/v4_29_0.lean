...
## 全新可扩展 `do`精化器
%%%
file := "New-Extensible-___do___-Elaborator"
tag := "zh-releases-v4-29-0-h003"
%%%
...
## mvcgen：本地上下文中的规范
%%%
file := "mvcgen___-Specifications-in-the-Local-Context"
tag := "zh-releases-v4-29-0-h004"
%%%
...
%%%
file := "grind___-Higher-Order-Miller-Pattern-Support-in-E-matching"
tag := "zh-releases-v4-29-0-h005"
%%%
...
## 每个本机计算一个公理
%%%
file := "One-Axiom-per-Native-Computation"
tag := "zh-releases-v4-29-0-h006"
%%%
...
%%%
file := "More-Reliable-Universe-Level-Inference-in-___inductive_________structure___-Commands"
tag := "zh-releases-v4-29-0-h007"
%%%
...
%%%
file := "Simpler-___noncomputable___-Semantics"
tag := "zh-releases-v4-29-0-h008"
%%%
...
## 实例和还原性处理的更改
%%%
file := "Changes-to-Instance-and-Reducibility-Handling"
tag := "zh-releases-v4-29-0-h009"
%%%
...
## 宇宙层级 作为输出参数
%%%
file := "Universe-Levels-as-Output-Parameters"
tag := "zh-releases-v4-29-0-h011"
%%%
...
## Lake 的新功能
%%%
file := "New-Features-in-Lake"
tag := "zh-releases-v4-29-0-h013"
%%%
